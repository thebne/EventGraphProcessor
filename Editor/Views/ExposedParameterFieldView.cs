...
namespace GraphProcessor
{
	...
	{
		public readonly bool isOwnParam;
        protected BaseGraphView	graphView;

		public ExposedParameter	parameter { get; private set; }

		public ExposedParameterFieldView(BaseGraphView graphView, ExposedParameter param, bool isOwnParam) 
			: base(null, param.name, param.shortType)
		{
			this.graphView = graphView;
			this.isOwnParam = isOwnParam;
			parameter = param;
