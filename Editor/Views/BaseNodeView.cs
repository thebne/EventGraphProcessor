...
namespace GraphProcessor
{
	...
	public class BaseNodeView : NodeView
	{
		...
		public event Action<SerializedProperty> onSettingChanged;
		...
		void InitializeDebug()
		{
			...
			computeOrderLabel.name = "compute-order";
		...
		protected void AddSettingField(FieldInfo field)
		{
			...
			element.Bind(owner.serializedGraph);
			element.RegisterValueChangeCallback(evt => onSettingChanged?.Invoke(evt.changedProperty));
